    ...
    tabPanel("Home", 
             ...
             fluidRow(
               ...
               column(4,
                      ...
                      tags$figcaption("Global near-surface currents map of Queensland. The arrows indicate current direction as an annual mean, whilst the blue dots indicate the location of reefs. The green marker represents the Normanby Catchment site, also considered as the “low-risk” area, while the red marker indicates the Herbert Catchment site, the “high-risk” area. Source: ArcGIS and student’s own work.",
...
model by students, using data sourced from the Australian Institution of Marine Science.", style = "width:600px; font-size:12px; margin-left:10px; margin-right:10px;"),
                            ...
                            tags$div(
                              "Sediment has the greatest impact on macroalgal growth, followed by temperature. However, since temperature cannot be controlled, it is important to look at sediment and nutrient run-off. Interestingly the nutrients do not have as great of an impact, which aligns with research (i.e., ",
                              tags$br(),
                              "• Sediment movement and storm events cause the increase in macroalgal growth",
                              tags$br(),
                              "• Heightened nutrient concentrations maintain the growth",
                              tags$br(),
                              tags$br(),
                              tags$br(),
    ...
    tabPanel("Current", 
             ...
             tags$div(
               class = "panel-contents-title",
               "Visualising The Movement of Currents"
             ),
    ...
    tabPanel("Nutrients", 
             ...
             tags$div(
               tags$br(),
               "The Great Barrier Reef Lagoon (GBRL) receives its largest nutrient input from riverine discharge. Since European settlement, the annual amount of total nitrogen entering the GBRL has increased by 5.7 times (Kroon et al. 2012). Similarly, the annual total phosphorus load has increased by 8.9 times. These nutrient increments are primarily caused by the use of fertilizers in sugar cane, horticulture, and other agricultural areas within the Great Barrier Reef catchment area (Rayment 2003, Waterhouse et al. 2012). Furthermore, there are nutrient losses from agricultural and urban lands due to soil erosion, which contribute to the increase in particulate-bound nutrients (Brodie and Mitchell 2005, McKergow et al. 2005b, Waterhouse et al. 2012).",
               tags$br(),
               "Elevated levels of nitrogen and phosphorus serve as essential nutrients for macroalgae, fuelling their rapid growth and reproduction. As a result, the overabundance of nitrogen and phosphorus in aquatic environments can lead to the excessive proliferation of macroalgae (Lapointe 1989), often forming dense mats or blooms that can negatively impact the coral ecosystem by outcompeting and shading, disrupting natural habitats, and depleting oxygen levels in the water (Lotze and Schramm 2000).",
               tags$br()
             ),
             tags$div(class = "panel-contents-plot",
                      tags$br(),
                      tagList(
                        sidebarLayout(
                          sidebarPanel(
                            ...
                            tags$div(
                              "The results of the graphs in the Herbert catchment show that, in general, there is a greater correlation between each of the nutrients and their effect on macroalgal growth rate during autumn. This is important to note, because when farming sugarcane, it is recommended to fertilise the crops about five months before harvest, which for Australia is between June and November. Therefore, the increased levels of nutrients during the autumnal months aligning with sugarcane farming practices show that the reefs are potentially being impacted by these practices. The Normanby catchment graphs show that they experience much smaller amounts of nutrient runoff than the Herbert catchment, with it mostly being zero. This therefore shows that there is no effect of nutrients on macroalgal growth in this region.",
                              tags$br(),
             ...
             tags$div(
               ...
               "References:",
               tags$br(),
"Brodie, J.E. and Mitchell, A.W., 2005. Nutrients in Australian tropical rivers: changes with agricultural development and implications for receiving environments. Marine and freshwater research, 56(3), pp.279-302.",
tags$br(),
"Kroon, F.J., Kuhnert, P.M., Henderson, B.L., Wilkinson, S.N., Kinsey-Henderson, A., Abbott, B., Brodie, J.E. and Turner, R.D., 2012. River loads of suspended solids, nitrogen, phosphorus and herbicides delivered to the Great Barrier Reef lagoon. Marine pollution bulletin, 65(4-9), pp.167-181.",
tags$br(),
"Lapointe, B.E., 1989. Macroalgal production and nutrient relations in oligotrophic areas of Florida Bay. Bulletin of Marine Science, 44(1), pp.312-323.",
tags$br(),
"Lotze, H.K. and Schramm, W., 2000. Ecophysiological traits explain species dominance patterns in macroalgal blooms. Journal of Phycology, 36(2), pp.287-295.",
tags$br(),
"McKergow, L.A., Prosser, I.P., Hughes, A.O. and Brodie, J., 2005. Regional scale nutrient modelling: exports to the Great Barrier Reef world heritage area. Marine pollution bulletin, 51(1-4), pp.186-199.",
tags$br(),
"Rayment, G.E., 2003. Water quality in sugar catchments of Queensland. Water Science and Technology, 48(7), pp.35-47.",
tags$br(),
"Waterhouse, J., Brodie, J., Lewis, S. and Mitchell, A., 2012. Quantifying the sources of pollutants in the Great Barrier Reef catchments and the relative risk to reef ecosystems. Marine pollution bulletin, 65(4-9), pp.394-406.",
               tags$br(),
               id = "reference-style"
             )
    ),
    tabPanel("Sediment", 
             ...
             tags$div(
               tags$br(),
               "Soil erosion is a significant contributor to contaminant discharges into the Great Barrier Reef Lagoon (GBRL). The mean annual total sediment supply (TSS) to the GBRL has increased by 5.5 times since European settlement (Kroon et al. 2012). Beef grazing dominated catchments of the Fitzroy and Burdekin contribute over 50% to the mean annual anthropogenic TSS load to the GBRL (Kroon et al. 2012). Sediment loads can promote macroalgal growth, which can lead to coral mortality. ",
               tags$br(),
               "The erosion of soil and the subsequent release of sediments into the water column provide additional nutrients and substrates for macroalgae, supporting their growth and colonization (Tyler, McGlathery and Anderson 2003). Additionally, the high concentration of TSS can reduce water clarity, allowing more light to penetrate the water column, which further stimulates macroalgal growth (Bilotta and Brazier 2008).",
               tags$br()
             ),
             tags$div(class = "panel-contents-plot",
                      ...
                      tagList(
                        sidebarLayout(
                          sidebarPanel(
                            ...
                            tags$div(
                              "The research found that total suspended solids (sediment) has the greatest effect on macroalgae growth. The amount of total suspended sediments was higher in the Herbert Catchment compared to the Normanby Catchment. Which is expected due to the higher amount of land use and agricultural runoff in the high-risk water catchment. Macroalgae growth rates were also higher in the Herbert Catchment, with a positive correlation between increased sediment and an increase in macroalgae growth.",
                              tags$br(),
                              id = "explanation-block-ss"
                            )
                          ),
                          mainPanel(
...
"Kroon, F.J., Kuhnert, P.M., Henderson, B.L., Wilkinson, S.N., Kinsey-Henderson, A., Abbott, B., Brodie, J.E. and Turner, R.D., 2012. River loads of suspended solids, nitrogen, phosphorus and herbicides delivered to the Great Barrier Reef lagoon. Marine pollution bulletin, 65(4-9), pp.167-181.",
tags$br(),
"Tyler, A.C., McGlathery, K.J. and Anderson, I.C., 2003. Benthic algae control sediment—water column fluxes of organic and inorganic nitrogen compounds in a temperate lagoon. Limnology and Oceanography, 48(6), pp.2125-2137.",
               tags$br(),
               id = "reference-style"
             )
    ),
                          ...
                          sidebarPanel(
                            fluidRow(
                              column(7, 
                                     ...
                                     sliderInput("PH_input", "PH (log(mM)):", min = 7.997, max = 8.145, value = 8.066),
                                     sliderInput("Turbidity_input", "Turbidity (NTU):", min = 0.1361, max = 1.3665, value = 0.1700)
                              ),
                              column(5,
                                     sliderInput("temp_input", "Temperature (Degrees Celsius):", min = 22.53, max = 33.05, value = 28.03),
                                     sliderInput("Oxygen_input", "Oxygen (mg O m-3):", min = 6368, max = 7127, value = 6675),
                                     sliderInput("current_speed_input", "Current Speed (ms-1):", min = 0.006858, max = 0.813074, value = 0.227600),
                                     sliderInput("TN_input", "Total Nitrogen (mg N m-3):", min = 43.11, max = 111.37, value = 47.91),
                                     sliderInput("TP_input", "Total Phosphate (mg P m-3):", min = 3.460, max = 9.509, value = 4.021)
                              )
                            )
                          ),
...
server <- function(input, output) {
  ...
  values$homemaplongmax <- 148
  values$homemaplongmin <- 145
  values$homemaplatmax <- -17
  values$homemaplatmin <- -18.5
  ...
  observeEvent(input$homecatchment, {
    if(input$homecatchment == "Herbert Catchment"){
      ...
      values$homemaplongmax <<- 145
      values$homemaplongmin <<- 146.5
      values$homemaplatmax <<- -15.6
      values$homemaplatmin <<- -14.8
    }
  })
  ...
  output$algaeGrowth <- renderPlot({
    ggplot() +
      geom_sf(data = oz_states, mapping = aes(fill = NAME), show.legend = FALSE)+
      coord_sf(xlim = c(values$homemaplongmin, values$homemaplongmax),ylim=c(values$homemaplatmin,values$homemaplatmax)) + geom_point(data = df_subset_alg(), alpha = 0.2, aes(y = latitude, x = longitude, size = MA_N_gr, color = MA_N_gr)) + 
